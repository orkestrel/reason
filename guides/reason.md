...
| `LogicalChainingOutcome`      | interface | `{ conclusion, rules }` — one `LogicalReasoner` chaining pass, forward or backward.                                                                                        |
| `InferentialChainingOutcome`  | interface | `{ derived, proof? }` — one `InferentialReasoner` chaining pass; `proof` only from the backward pass.                                                                      |
